...
export type C10H12ONodeOptions = SelfOptions & MoleculeNodeOptions;

export default class C10H12ONode extends MoleculeNode {

  public constructor( providedOptions?: C10H12ONodeOptions ) {
    ...
    const atomNodes = [ topNode, topRightNode, rightNode, bottomNode, bottomLeftNode, leftNode,
                        ...
                        sideC1Node, H7Node, sideC2Node, ONode, H1Node, sideC3Node, H6Node, sideC4Node,
...
nitroglycerin.register( 'C10H12ONode', C10H12ONode );
